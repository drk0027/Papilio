            ...
            return (// panel para usuarios admin
                <Layout home login={props.isLoggedIn} token={props.token} info_sistema={props.info_sistema}>
                    <Container fluid>
                        ...
                        <Row>
                            <Col>
                                <h3>Mensajes del sistema para el usuario</h3>
                                <hr></hr>
                            </Col>
                        </Row>
                        <Row>
                            <Col>
                                <p>Aqui el administrador puede crear mensajes y adjuntar archivos a manera de notificaciones que apareceran en el dashboard del cliente</p>
                            </Col>
                        </Row>
                        <Container fluid>
                            <Row>
