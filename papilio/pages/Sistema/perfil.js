...
import Seguridad from '../../components/admin/sistema/seguridad'
import Seguridad_user from '../../components/user/sistema/seguridad'
import Perfil from '../../components/user/sistema/perfil'
...
export async function getServerSideProps(context) {
    ...
    */
    ...
    if (isLoggedIn == true) {//si el usuario ha iniciado sesion
        ...
        if (Auth.getPerfil(token).roles == 2) {//si el usuario es usuario
            var sistema = []
            await Auth.ServerFetch(//carga la lista de campos para las configuraciones del sistema (solo lo pueden ver los administradores)
                global.server + "api/user/ver_perfil",
                {
                    method: 'POST',
                    body: JSON.stringify(),
                },
            ...
            return (// panel para usuarios admin
                <Layout home login={props.isLoggedIn} token={props.token} info_sistema={props.info_sistema}>
                    <Container fluid>
                        ...
                        <Row>
                            <Col>
                                <p>Aqui el administrador puede cambiar su contraseña</p>
                            </Col>
                        </Row>
                        <Container fluid>
                            <Row>
                                <Col>
                                    <Seguridad sistema={props.sistema}></Seguridad>
                                </Col>
                            </Row>
                        </Container>
                    </Container>
            ...
            return (
                <Layout home login={props.isLoggedIn} token={props.token} info_sistema={props.info_sistema}>
                    <Container fluid>
                        ...
                        <Row>
                            <Col>
                                <h3>Actualizar informacion personal</h3>
                                <hr></hr>
                            </Col>
                        </Row>
                        <Row>
                            <Col>
                                <p>Aqui el usuario podra actualizar sus datos personales</p>
                            </Col>
                        </Row>
                        <Container fluid>
                            <Row>
                                <Col>
                                    <Perfil props={props.sistema}/>
                                </Col>
                            </Row>
                        </Container>
                    </Container>
