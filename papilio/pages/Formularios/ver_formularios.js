...
import Ver_formularios from '../../components/admin/formularios/ver_formularios'
            ...
            return (// panel para usuarios admin
                <Layout home login={props.isLoggedIn} token={props.token} info_sistema={props.info_sistema}>
                    <Container fluid>
                        ...
                        <Row>
                            <Col>
                                <h3>Ver Solicitudes de informacion</h3>
                                <hr></hr>
                            </Col>
                        </Row>
                        <Row>
                            <Col>
                                <p>Aqui puede revisar la lista de personas que han solicitado informacion por medio de los formularios</p>
                            </Col>
                        </Row>
                        <Container fluid>
                            <Row>
                                <Col>
                                    <Ver_formularios sistema={props.sistema} />
                                </Col>
                            </Row>
                        </Container>
                    </Container>
